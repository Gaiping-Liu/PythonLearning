...
class Spider_Youdao:
    ...
    def ExtractPage(self, searchWord):
        ...
        try:
            ...
            if(keyWords != None and myItems == None):
                myItems = re.search(r'<span class="pronounce">\n.*<span class="phonetic">\[(.+?)\]',MyPage)
    ...
    def Start(self):
        ...
        offset = 70
        i=offset%1000
        n=str(int((startline+offset)/1000)+1)
        for line in allLines[startline+offset: startline+25000]:
           if i<1000:
